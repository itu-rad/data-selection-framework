...
def recipe_main(cfg: DictConfig) -> None:
    ...
    """
    print("Entering recipe_main in test_full_finetune")
    config.log_config(recipe_name="FullFinetuneRecipeSingleDevice", cfg=cfg)
    recipe = FullFinetuneRecipeSingleDevice(cfg=cfg)
    print("Starting test_full_finetune setup()")
    recipe.setup(cfg=cfg)
    print("starting test_full_finetune train()")
    recipe.train()
    print("starting test_full_finetune cleanup()")
    recipe.cleanup()
